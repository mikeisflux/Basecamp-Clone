...
class BCWP_Chat {
    ...
    public static function create_message( $data ) {
        ...
        return BCWP_Database::insert( 'chat_messages', $data );
    }

    public static function get_message( $message_id ) {
        return BCWP_Database::get_row( 'chat_messages', array( 'id' => $message_id ) );
    }
    ...
    public static function get_messages_since( $project_id, $since_id ) {
        ...
        $sql = "SELECT * FROM " . BCWP_Database::get_table_name( 'chat_messages' ) . "
    ...
    public static function update_message( $message_id, $data ) {
        ...
        return BCWP_Database::update( 'chat_messages', $data, array( 'id' => $message_id ) );
    }
