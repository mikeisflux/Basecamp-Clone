...
class PFOB_Activity {
    ...
    public static function get_recent( $args = array() ) {
        ...
        $sql = "SELECT * FROM {$wpdb->prefix}pfob_activities
                WHERE {$where_clause}
    ...
    public static function get_user_timeline( $user_id, $limit = 50 ) {
        ...
        $project_ids = $wpdb->get_col( $wpdb->prepare(
            "SELECT project_id FROM {$wpdb->prefix}pfob_project_members WHERE user_id = %d",
            $user_id
        ) );
    ...
    public static function get_count( $args = array() ) {
        ...
        $sql = "SELECT COUNT(*) FROM {$wpdb->prefix}pfob_activities WHERE {$where_clause}";
