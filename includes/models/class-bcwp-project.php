...
class BCWP_Project {
    ...
    public static function create( $data ) {
        ...
        $project_id = BCWP_Database::insert( 'projects', $data );
    ...
    public static function get( $project_id ) {
        $project = BCWP_Database::get_row( 'projects', array( 'id' => $project_id ) );
    ...
    public static function get_by_slug( $slug ) {
        $project = BCWP_Database::get_row( 'projects', array( 'slug' => $slug ) );
    ...
    public static function add_member( $project_id, $user_id, $role = 'member' ) {
        ...
        $member_id = BCWP_Database::insert( 'project_members', array(
            'project_id' => $project_id,
            'user_id'    => $user_id,
            'role'       => $role,
    ...
    public static function remove_member( $project_id, $user_id ) {
        return BCWP_Database::delete( 'project_members', array(
            'project_id' => $project_id,
            'user_id'    => $user_id,
        ) );
    }
    ...
    public static function is_member( $project_id, $user_id ) {
        return BCWP_Database::exists( 'project_members', array(
            'project_id' => $project_id,
            'user_id'    => $user_id,
        ) );
    }
    ...
    private static function create_default_tools( $project_id ) {
        ...
        foreach ( $default_tools as $tool ) {
            BCWP_Database::insert( 'project_tools', array(
                'project_id' => $project_id,
    ...
    private static function generate_unique_slug( $slug ) {
        ...
        while ( BCWP_Database::exists( 'projects', array( 'slug' => $slug ) ) ) {
