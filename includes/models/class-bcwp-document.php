...
class BCWP_Document {
    ...
    public static function create( $data ) {
        ...
        return BCWP_Database::insert( 'documents', $data );
    }

    public static function get( $document_id ) {
        return BCWP_Database::get_row( 'documents', array( 'id' => $document_id ) );
    }
    ...
    public static function update( $document_id, $data ) {
        ...
        return BCWP_Database::update( 'documents', $data, array( 'id' => $document_id ) );
    }
    ...
    public static function delete( $document_id ) {
        ...
        return BCWP_Database::delete( 'documents', array( 'id' => $document_id ) );
    }
