...
class PFOB_Events_Endpoint {
    ...
    public function get_events( $request ) {
        ...
        $events = PFOB_Event::get_project_events( $project_id, $start, $end );
    ...
    public function create_event( $request ) {
        ...
        if ( ! PFOB_Permission_Service::can_create_content( $project_id, 'event' ) ) {
            return new WP_Error( 'access_denied', 'Access denied', array( 'status' => 403 ) );
        }
        ...
        $event_id = PFOB_Event::create( $event_data );
    ...
    public function export_ical( $request ) {
        ...
        $ical .= "VERSION:2.0\r\n";
        $ical .= "PRODID:-//ProjectFOB//Events Calendar//EN\r\n";
    ...
    public function update_event( $request ) {
        ...
        if ( ! PFOB_Permission_Service::can_edit_content( 'event', $event_id ) ) {
            return new WP_Error( 'access_denied', 'Access denied', array( 'status' => 403 ) );
        }
        ...
        $result = PFOB_Event::update( $event_id, $update_data );
    ...
    public function delete_event( $request ) {
        ...
        if ( ! PFOB_Permission_Service::can_delete_content( 'event', $event_id ) ) {
            return new WP_Error( 'access_denied', 'Access denied', array( 'status' => 403 ) );
        }

        PFOB_Event::delete( $event_id );
