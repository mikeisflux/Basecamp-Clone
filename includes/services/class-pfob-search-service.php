...
class PFOB_Search_Service {
    ...
    private static function search_messages( $query, $project_id = null ) {
        ...
        $sql = "SELECT * FROM " . PFOB_Database::get_table_name( 'messages' ) . "
                WHERE is_archived = 0
    ...
    private static function search_todos( $query, $project_id = null ) {
        ...
        $sql = "SELECT ti.*, tl.project_id FROM " . PFOB_Database::get_table_name( 'todo_items' ) . " ti
    ...
    private static function search_documents( $query, $project_id = null ) {
        ...
        $sql = "SELECT * FROM " . PFOB_Database::get_table_name( 'documents' ) . "
    ...
    private static function search_cards( $query, $project_id = null ) {
        ...
        $sql = "SELECT * FROM " . PFOB_Database::get_table_name( 'cards' ) . "
                WHERE is_archived = 0
