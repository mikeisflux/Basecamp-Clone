...
class BCWP_Card {
    ...
    public static function create_column( $data ) {
        return BCWP_Database::insert( 'card_columns', $data );
    }

    public static function get_column( $column_id ) {
        return BCWP_Database::get_row( 'card_columns', array( 'id' => $column_id ) );
    }
    ...
    public static function update_column( $column_id, $data ) {
        return BCWP_Database::update( 'card_columns', $data, array( 'id' => $column_id ) );
    }

    public static function delete_column( $column_id ) {
        return BCWP_Database::delete( 'card_columns', array( 'id' => $column_id ) );
    }
    ...
    public static function create_card( $data ) {
        ...
        return BCWP_Database::insert( 'cards', $data );
    }

    public static function get_card( $card_id ) {
        return BCWP_Database::get_row( 'cards', array( 'id' => $card_id ) );
    }
    ...
    public static function update_card( $card_id, $data ) {
        ...
        return BCWP_Database::update( 'cards', $data, array( 'id' => $card_id ) );
    }

    public static function delete_card( $card_id ) {
        return BCWP_Database::delete( 'cards', array( 'id' => $card_id ) );
    }
