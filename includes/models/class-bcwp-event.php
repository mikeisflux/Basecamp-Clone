...
class BCWP_Event {
    ...
    public static function create( $data ) {
        ...
        return BCWP_Database::insert( 'events', $data );
    }

    public static function get( $event_id ) {
        return BCWP_Database::get_row( 'events', array( 'id' => $event_id ) );
    }
    ...
    public static function update( $event_id, $data ) {
        ...
        return BCWP_Database::update( 'events', $data, array( 'id' => $event_id ) );
    }

    public static function delete( $event_id ) {
        return BCWP_Database::delete( 'events', array( 'id' => $event_id ) );
    }
