...
class PFOB_WebSocket_Service {

    /**
     * Check if WebSocket is enabled.
     */
    public static function is_enabled() {
        return get_option( 'pfob_websocket_enabled' ) === '1';
    }
    ...
    public static function get_server_url() {
        return get_option( 'pfob_websocket_url', 'http://localhost:3000' );
    }
    ...
    private static function get_secret() {
        return get_option( 'pfob_websocket_secret', '' );
    }
    ...
    public static function broadcast_chat_message( $project_id, $message ) {
        return self::trigger_event( $project_id, 'chat-message', array(
            ...
            'userName' => PFOB_Auth_Service::get_user_display_name( $message->user_id ),
    ...
    public static function broadcast_activity( $project_id, $activity ) {
        return self::trigger_event( $project_id, 'activity-update', array(
            ...
            'userName' => PFOB_Auth_Service::get_user_display_name( $activity->user_id ),
    ...
    public static function generate_token( $user_id ) {
        ...
        $secret = get_option( 'pfob_websocket_secret', wp_salt() );
