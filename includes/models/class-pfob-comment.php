...
class PFOB_Comment {
    ...
    public static function create( $data ) {
        ...
        return PFOB_Database::insert( 'comments', $data );
    }
    ...
    public static function get( $comment_id ) {
        ...
        return $wpdb->get_row( $wpdb->prepare(
            "SELECT * FROM " . PFOB_Database::get_table_name( 'comments' ) . " WHERE id = %d",
            $comment_id
        ) );
    }
    ...
    public static function get_for_subject( $subject_type, $subject_id ) {
        ...
        return $wpdb->get_results( $wpdb->prepare(
            "SELECT * FROM " . PFOB_Database::get_table_name( 'comments' ) . "
    ...
    public static function update( $comment_id, $data ) {
        ...
        return PFOB_Database::update( 'comments', $data, array( 'id' => $comment_id ) );
    }
    ...
    public static function delete( $comment_id ) {
        return PFOB_Database::delete( 'comments', array( 'id' => $comment_id ) );
    }
    ...
    public static function get_count( $subject_type, $subject_id ) {
        ...
        return (int) $wpdb->get_var( $wpdb->prepare(
            "SELECT COUNT(*) FROM " . PFOB_Database::get_table_name( 'comments' ) . "
            WHERE subject_type = %s AND subject_id = %d",
            $subject_type,
            $subject_id
        ) );
